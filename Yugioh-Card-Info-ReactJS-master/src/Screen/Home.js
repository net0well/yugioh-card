              ...
              <Row>
                <Col xs={12} sm={12} md={12} lg={12}>
                  <div className="text-center">
                    <a href="https://github.com/net0well" target="_nblank" className="link">
                      <AiFillGithub size={24} className="mr-2" />
                    </a>
                    <a href="http://linked.in/dev.wneto" target="_nblank" className="link">
                      <AiFillLinkedin size={24} className="mr-2" />
                    </a>
                    <a href="https://www.facebook.com/net0well" target="_nblank" className="link">
                      <AiFillFacebook size={24} className="mr-2" />
                    </a>
                    <a href="https://twitter.com/net0well" target="_nblank" className="link">
